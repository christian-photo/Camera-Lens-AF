...
namespace LensAF.Items
{
    ...
    public class AFAfterExposures : SequenceTrigger, IValidatable
    {
        ...
        public AFAfterExposures(IImageHistoryVM history, ICameraMediator camera, IImagingMediator imaging, IProfileService profile)
        {
        ...
        {
            return new AFAfterExposures(history, cam, imaging, profile)
            {
                Icon = Icon,
                Name = Name,
                Category = Category,
